...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint64_t Index, uint64_t& PO, uint64_t& NO, uint64_t& OP, uint64_t& ON) const {
    GetConsecutives2_RM(Dimensions(), Index, PO, NO, OP, ON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint64_t Index, uint64_t& PP, uint64_t& OP, uint64_t& NP, uint64_t& PO, uint64_t& NO, uint64_t& PN, uint64_t& ON, uint64_t& NN) const {
    GetConsecutives2_RM(Dimensions(), Index, PP, OP, NP, PO, NO, PN, ON, NN);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint64_t Index, _T*& PO, _T*& NO, _T*& OP, _T*& ON) const {
    uint64_t iPO;
    uint64_t iNO;
    uint64_t iOP;
    uint64_t iON;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint64_t Index, _T*& PP, _T*& OP, _T*& NP, _T*& PO, _T*& NO, _T*& PN, _T*& ON, _T*& NN) const {
    uint64_t iPP;
    uint64_t iOP;
    uint64_t iNP;
    uint64_t iPO;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint64_t Index, uint32_2& PO, uint32_2& NO, uint32_2& OP, uint32_2& ON) const {
    GetConsecutives2_RM(Dimensions(), Index, PO, NO, OP, ON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint64_t Index, uint32_2& PP, uint32_2& OP, uint32_2& NP, uint32_2& PO, uint32_2& NO, uint32_2& PN, uint32_2& ON, uint32_2& NN) const {
    GetConsecutives2_RM(Dimensions(), Index, PP, OP, NP, PO, NO, PN, ON, NN);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint32_2 Coordinates, uint64_t& PO, uint64_t& NO, uint64_t& OP, uint64_t& ON) const {
    GetConsecutives2_RM(Dimensions(), Coordinates, PO, NO, OP, ON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint32_2 Coordinates, uint64_t& PP, uint64_t& OP, uint64_t& NP, uint64_t& PO, uint64_t& NO, uint64_t& PN, uint64_t& ON, uint64_t& NN) const {
    GetConsecutives2_RM(Dimensions(), Coordinates, PP, OP, NP, PO, NO, PN, ON, NN, PP, OP, NP, PO, NO, PN, ON, NN);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint32_2 Coordinates, _T*& PO, _T*& NO, _T*& OP, _T*& ON) const {
    uint64_t iPO;
    uint64_t iNO;
    uint64_t iOP;
    uint64_t iON;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint32_2 Coordinates, _T*& PP, _T*& OP, _T*& NP, _T*& PO, _T*& NO, _T*& PN, _T*& ON, _T*& NN) const {
    uint64_t iPP;
    uint64_t iOP;
    uint64_t iNP;
    uint64_t iPO;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint32_2 Coordinates, uint32_2& PO, uint32_2& NO, uint32_2& OP, uint32_2& ON) const {
    GetConsecutives2(Dimensions(), Coordinates, PO, NO, OP, ON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(uint32_2 Coordinates, uint32_2& PP, uint32_2& OP, uint32_2& NP, uint32_2& PO, uint32_2& NO, uint32_2& PN, uint32_2& ON, uint32_2& NN) const {
    GetConsecutives2(Dimensions(), Coordinates, PP, OP, NP, PO, NO, PN, ON, NN, PP);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(_T*& Pointer, uint64_t& PO, uint64_t& NO, uint64_t& OP, uint64_t& ON) const {
    GetConsecutives2(Dimensions(), PointerToIndex(Pointer), PO, NO, OP, ON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(_T*& Pointer, uint64_t& PP, uint64_t& OP, uint64_t& NP, uint64_t& PO, uint64_t& NO, uint64_t& PN, uint64_t& ON, uint64_t& NN) const {
    GetConsecutives2(Dimensions(), PointerToIndex(Pointer), PP, OP, NP, PO, NO, PN, ON, NN);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(_T*& Pointer, _T*& PO, _T*& NO, _T*& OP, _T*& ON) const {
    GetConsecutives2(Dimensions(), PointerToIndex(Pointer), PO, NO, OP, ON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(_T*& Pointer, _T*& PP, _T*& OP, _T*& NP, _T*& PO, _T*& NO, _T*& PN, _T*& ON, _T*& NN) const {
    GetConsecutives2(Dimensions(), PointerToIndex(Pointer), PP, OP, NP, PO, NO, PN, ON, NN);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(_T*& Pointer, uint32_2& PO, uint32_2& NO, uint32_2& OP, uint32_2& ON) const {
    GetConsecutives2(Dimensions(), PointerToCoordinates(Pointer), PO, NO, OP, ON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField2<_T>::GetConsecutives(_T*& Pointer, uint32_2& PP, uint32_2& OP, uint32_2& NP, uint32_2& PO, uint32_2& NO, uint32_2& PN, uint32_2& ON, uint32_2& NN) const {
