...
namespace BrendanCUDA {
    namespace Fields {
        ...
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint32_t Index, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint32_t Index, uint32_t& PPP, uint32_t& OPP, uint32_t& NPP, uint32_t& POP, uint32_t& OOP, uint32_t& NOP, uint32_t& PNP, uint32_t& ONP, uint32_t& NNP, uint32_t& PPO, uint32_t& OPO, uint32_t& NPO, uint32_t& POO, uint32_t& NOO, uint32_t& PNO, uint32_t& ONO, uint32_t& NNO, uint32_t& PPN, uint32_t& OPN, uint32_t& NPN, uint32_t& PON, uint32_t& OON, uint32_t& NON, uint32_t& PNN, uint32_t& ONN, uint32_t& NNN);
        __host__ __device__ void GetConsecutives_CM(uint32_3 Dimensions, uint32_t Index, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        ...
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint32_3 Coordinates, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint32_3 Coordinates, uint32_t& PPP, uint32_t& OPP, uint32_t& NPP, uint32_t& POP, uint32_t& OOP, uint32_t& NOP, uint32_t& PNP, uint32_t& ONP, uint32_t& NNP, uint32_t& PPO, uint32_t& OPO, uint32_t& NPO, uint32_t& POO, uint32_t& NOO, uint32_t& PNO, uint32_t& ONO, uint32_t& NNO, uint32_t& PPN, uint32_t& OPN, uint32_t& NPN, uint32_t& PON, uint32_t& OON, uint32_t& NON, uint32_t& PNN, uint32_t& ONN, uint32_t& NNN);
        __host__ __device__ void GetConsecutives_CM(uint32_3 Dimensions, uint32_3 Coordinates, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        __host__ __device__ void GetConsecutives_CM(uint32_3 Dimensions, uint32_3 Coordinates, uint32_t& PPP, uint32_t& OPP, uint32_t& NPP, uint32_t& POP, uint32_t& OOP, uint32_t& NOP, uint32_t& PNP, uint32_t& ONP, uint32_t& NNP, uint32_t& PPO, uint32_t& OPO, uint32_t& NPO, uint32_t& POO, uint32_t& NOO, uint32_t& PNO, uint32_t& ONO, uint32_t& NNO, uint32_t& PPN, uint32_t& OPN, uint32_t& NPN, uint32_t& PON, uint32_t& OON, uint32_t& NON, uint32_t& PNN, uint32_t& ONN, uint32_t& NNN);
        __host__ __device__ void GetConsecutives_RM(uint64_3 Dimensions, uint32_t Index, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        ...
        __host__ __device__ void GetConsecutives_CM(uint64_3 Dimensions, uint32_t Index, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        ...
        __host__ __device__ void GetConsecutives_RM(uint64_3 Dimensions, uint64_3 Coordinates, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        __host__ __device__ void GetConsecutives_RM(uint64_3 Dimensions, uint64_3 Coordinates, uint32_t& PPP, uint32_t& OPP, uint32_t& NPP, uint32_t& POP, uint32_t& OOP, uint32_t& NOP, uint32_t& PNP, uint32_t& ONP, uint32_t& NNP, uint32_t& PPO, uint32_t& OPO, uint32_t& NPO, uint32_t& POO, uint32_t& NOO, uint32_t& PNO, uint32_t& ONO, uint32_t& NNO, uint32_t& PPN, uint32_t& OPN, uint32_t& NPN, uint32_t& PON, uint32_t& OON, uint32_t& NON, uint32_t& PNN, uint32_t& ONN, uint32_t& NNN);
        __host__ __device__ void GetConsecutives_CM(uint64_3 Dimensions, uint64_3 Coordinates, uint32_t& POO, uint32_t& NOO, uint32_t& OPO, uint32_t& ONO, uint32_t& OOP, uint32_t& OON);
        ...
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint64_t Index, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint64_t Index, uint64_t& PPP, uint64_t& OPP, uint64_t& NPP, uint64_t& POP, uint64_t& OOP, uint64_t& NOP, uint64_t& PNP, uint64_t& ONP, uint64_t& NNP, uint64_t& PPO, uint64_t& OPO, uint64_t& NPO, uint64_t& POO, uint64_t& NOO, uint64_t& PNO, uint64_t& ONO, uint64_t& NNO, uint64_t& PPN, uint64_t& OPN, uint64_t& NPN, uint64_t& PON, uint64_t& OON, uint64_t& NON, uint64_t& PNN, uint64_t& ONN, uint64_t& NNN);
        __host__ __device__ void GetConsecutives_CM(uint32_3 Dimensions, uint64_t Index, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
        ...
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint32_3 Coordinates, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
        __host__ __device__ void GetConsecutives_RM(uint32_3 Dimensions, uint32_3 Coordinates, uint64_t& PPP, uint64_t& OPP, uint64_t& NPP, uint64_t& POP, uint64_t& OOP, uint64_t& NOP, uint64_t& PNP, uint64_t& ONP, uint64_t& NNP, uint64_t& PPO, uint64_t& OPO, uint64_t& NPO, uint64_t& POO, uint64_t& NOO, uint64_t& PNO, uint64_t& ONO, uint64_t& NNO, uint64_t& PPN, uint64_t& OPN, uint64_t& NPN, uint64_t& PON, uint64_t& OON, uint64_t& NON, uint64_t& PNN, uint64_t& ONN, uint64_t& NNN);
        __host__ __device__ void GetConsecutives_CM(uint32_3 Dimensions, uint32_3 Coordinates, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
        ...
        __host__ __device__ void GetConsecutives_RM(uint64_3 Dimensions, uint64_t Index, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
        ...
        __host__ __device__ void GetConsecutives_CM(uint64_3 Dimensions, uint64_t Index, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
        ...
        __host__ __device__ void GetConsecutives_RM(uint64_3 Dimensions, uint64_3 Coordinates, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
        ...
        __host__ __device__ void GetConsecutives_CM(uint64_3 Dimensions, uint64_3 Coordinates, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON);
