...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(uint64_t Index, _T*& POO, _T*& NOO, _T*& OPO, _T*& ONO, _T*& OOP, _T*& OON) const {
    uint64_t iPOO;
    uint64_t iNOO;
    uint64_t iOPO;
    uint64_t iONO;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(uint64_t Index, _T*& PPP, _T*& OPP, _T*& NPP, _T*& POP, _T*& OOP, _T*& NOP, _T*& PNP, _T*& ONP, _T*& NNP, _T*& PPO, _T*& OPO, _T*& NPO, _T*& POO, _T*& NOO, _T*& PNO, _T*& ONO, _T*& NNO, _T*& PPN, _T*& OPN, _T*& NPN, _T*& PON, _T*& OON, _T*& NON, _T*& PNN, _T*& ONN, _T*& NNN) const {
    uint64_t iPPP;
    uint64_t iOPP;
    uint64_t iNPP;
    uint64_t iPOP;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(uint64_t Index, uint32_3& POO, uint32_3& NOO, uint32_3& OPO, uint32_3& ONO, uint32_3& OOP, uint32_3& OON) const {
    GetConsecutives3_RM(Dimensions(), Index, POO, NOO, OPO, ONO, OOP, OON);
}
template <typename _T>
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(uint32_3 Coordinates, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON) const {
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(uint32_3 Coordinates, _T*& POO, _T*& NOO, _T*& OPO, _T*& ONO, _T*& OOP, _T*& OON) const {
    uint64_t iPOO;
    uint64_t iNOO;
    uint64_t iOPO;
    uint64_t iONO;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(uint32_3 Coordinates, _T*& PPP, _T*& OPP, _T*& NPP, _T*& POP, _T*& OOP, _T*& NOP, _T*& PNP, _T*& ONP, _T*& NNP, _T*& PPO, _T*& OPO, _T*& NPO, _T*& POO, _T*& NOO, _T*& PNO, _T*& ONO, _T*& NNO, _T*& PPN, _T*& OPN, _T*& NPN, _T*& PON, _T*& OON, _T*& NON, _T*& PNN, _T*& ONN, _T*& NNN) const {
    uint64_t iPPP;
    uint64_t iOPP;
    uint64_t iNPP;
    uint64_t iPOP;
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(uint32_3 Coordinates, uint32_3& POO, uint32_3& NOO, uint32_3& OPO, uint32_3& ONO, uint32_3& OOP, uint32_3& OON) const {
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(_T*& Pointer, uint64_t& POO, uint64_t& NOO, uint64_t& OPO, uint64_t& ONO, uint64_t& OOP, uint64_t& OON) const {
...
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(_T*& Pointer, _T*& POO, _T*& NOO, _T*& OPO, _T*& ONO, _T*& OOP, _T*& OON) const {
    GetConsecutives3(Dimensions(), PointerToIndex(Pointer), POO, NOO, OPO, ONO, OOP, OON);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(_T*& Pointer, _T*& PPP, _T*& OPP, _T*& NPP, _T*& POP, _T*& OOP, _T*& NOP, _T*& PNP, _T*& ONP, _T*& NNP, _T*& PPO, _T*& OPO, _T*& NPO, _T*& POO, _T*& NOO, _T*& PNO, _T*& ONO, _T*& NNO, _T*& PPN, _T*& OPN, _T*& NPN, _T*& PON, _T*& OON, _T*& NON, _T*& PNN, _T*& ONN, _T*& NNN) const {
    GetConsecutives3(Dimensions(), PointerToIndex(Pointer), PPP, OPP, NPP, POP, OOP, NOP, PNP, ONP, NNP, PPO, OPO, NPO, POO, NOO, PNO, ONO, NNO, PPN, OPN, NPN, PON, OON, NON, PNN, ONN, NNN);
}
template <typename _T>
__host__ __device__ __forceinline void BrendanCUDA::Fields::DField3<_T>::GetConsecutives(_T*& Pointer, uint32_3& POO, uint32_3& NOO, uint32_3& OPO, uint32_3& ONO, uint32_3& OOP, uint32_3& OON) const {
