    ...
    namespace AI {
        namespace MLPB {
            ...
            public:
                ...
                __host__ __device__ __forceinline MLPB ReproduceWFlips(uint32_t WeightsFlipProb, uint32_t BiasFlipProb, Random::AnyRNG<uint64_t> RNG) const;
                ...
                __host__ __device__ __forceinline MLPB ReproduceWTargets(uint32_t WeightsEachFlipProb, uint32_t BiasFlipProb, Random::AnyRNG<uint64_t> RNG) const;
                ...
                __host__ __device__ __forceinline MLPB ReproduceWMutations(uint32_t WeightsMutationProb, uint32_t WeightsProbOf1, uint32_t BiasMutationProb, uint32_t BiasProbOf1, Random::AnyRNG<uint64_t> RNG) const;
                ...
                static __forceinline void Deserialize(const void*& Data, MLPB& Value);
            private:
                MLPBLW* layers;
                size_t layerCount;
            };
...
__host__ __device__ __forceinline void BrendanCUDA::AI::MLPB::MLPB::RandomizeWFlips(uint32_t WeightsFlipProb, uint32_t BiasFlipProb, Random::AnyRNG<uint64_t> RNG) {
    for (size_t i = 0; i < layerCount; ++i) {
#if __CUDA_ARCH__
...
__host__ __device__ __forceinline auto BrendanCUDA::AI::MLPB::MLPB::ReproduceWFlips(uint32_t WeightsFlipProb, uint32_t BiasFlipProb, Random::AnyRNG<uint64_t> RNG) const -> MLPB {
    MLPB n = Clone();
    n.RandomizeWFlips(WeightsFlipProb, BiasFlipProb, RNG);
    return n;
}
__host__ __device__ __forceinline void BrendanCUDA::AI::MLPB::MLPB::RandomizeWTargets(uint32_t WeightsEachFlipProb, uint32_t BiasFlipProb, Random::AnyRNG<uint64_t> RNG) {
    for (size_t i = 0; i < layerCount; ++i) {
#if __CUDA_ARCH__
...
__host__ __device__ __forceinline auto BrendanCUDA::AI::MLPB::MLPB::ReproduceWTargets(uint32_t WeightsEachFlipProb, uint32_t BiasFlipProb, Random::AnyRNG<uint64_t> RNG) const -> MLPB {
    MLPB n = Clone();
    n.RandomizeWTargets(WeightsEachFlipProb, BiasFlipProb, RNG);
    return n;
}
__host__ __device__ __forceinline void BrendanCUDA::AI::MLPB::MLPB::RandomizeWMutations(uint32_t WeightsMutationProb, uint32_t WeightsProbOf1, uint32_t BiasMutationProb, uint32_t BiasProbOf1, Random::AnyRNG<uint64_t> RNG) {
    for (size_t i = 0; i < layerCount; ++i) {
#if __CUDA_ARCH__
...
__host__ __device__ __forceinline auto BrendanCUDA::AI::MLPB::MLPB::ReproduceWMutations(uint32_t WeightsMutationProb, uint32_t WeightsProbOf1, uint32_t BiasMutationProb, uint32_t BiasProbOf1, Random::AnyRNG<uint64_t> RNG) const -> MLPB {
    MLPB n = Clone();
...
__forceinline void BrendanCUDA::AI::MLPB::MLPB::Deserialize(const void*& Data, MLPB& Value) {
    Value = MLPB(BSerializer::Deserialize<size_t>(Data));
    for (size_t i = 0; i < Value.layerCount; ++i) {
        Value.SetLayer(i, MLPBLW::Deserialize(Data));
    }
}