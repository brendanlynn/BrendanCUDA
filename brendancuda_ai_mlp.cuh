    ...
    namespace AI {
        namespace MLP {
            ...
            public:
                ...
                __host__ __device__ MLP<T> Reproduce(T Scalar, Random::rngWState<uint64_t> rng) const;
                __host__ __device__ MLP<T> Reproduce(T Scalar, T LowerBound, T UpperBound, Random::rngWState<uint64_t> rng) const;
